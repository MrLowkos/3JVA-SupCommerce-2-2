							...
							+ "<div class=\"col-sx-12 col-sm-6 col-md-4 col-lg-3\">"
								+ "<article class=\"panel panel-primary\">"
									+ "<header class=\"panel-heading\">"
										+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-2-2/showProduct?id=" + Long.toString(product.getId()) + "\"><span class=\"glyphicon glyphicon-tag\"></span>&nbsp; Product Id " + Long.toString(product.getId()) + "</a></h3>"
									+ "</header>"
