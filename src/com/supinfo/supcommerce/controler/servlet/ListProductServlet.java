 						...
 						+ "<div class=\"container\">"
 							+ "<header class=\"navbar-header\">"
 								+ "<button class=\"navbar-toggle collapsed\" data-target=\".navbar-collapse\" data-toggle=\"collapse\" type=\"button\">"
 									...
 									+ "<span class=\"icon-bar\"></span>"
 								+ "</button>"
 								+ "<a class=\"navbar-brand\" href=\"/SupCommerce-2-2\">SupCommerce 2.2</a>"
 							+ "</header>"
 							+ "<nav class=\"navbar-collapse collapse\" style=\"height: 0.8px;\">"
 								+ "<ul class=\"nav navbar-nav\">"
 									...
 									+ "<li class=\"active\"><a href=\"/SupCommerce-2-2/listProduct\"><span class=\"glyphicon glyphicon-list\"></span>&nbsp; Products List</a></li>"
 									+ "<li><a href=\"/SupCommerce-2-2/auth/basicInsert\"><span class=\"glyphicon glyphicon-random\"></span>&nbsp; Random Product</a></li>"
 								+ "</ul>"
 							+ "</nav>"
 						+ "</div>"
 					+ "</div>"
									...
									out.println(
										...
										+ "<article class=\"panel panel-primary\">"
											+ "<header class=\"panel-heading\">"
												...
												+ "<h3><a style=\"color: #FFF;\" href=\"/SupCommerce-2-2/showProduct?id=" + Long.toString(p.getId()) + "\">"
