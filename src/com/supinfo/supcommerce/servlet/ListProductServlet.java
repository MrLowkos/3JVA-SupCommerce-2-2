...
public class ListProductServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		+ "<nav>"
		+ "<ul>"
		+ "<li><a href=\"/SupCommerce-2-2\">Home</a></li>"
		+ "<li class=\"active\"><a href=\"/SupCommerce-2-2/listProduct\">Products List</a></li>"
		...
		// Else we browse productList and print information for each product
			...
			for (SupProduct product : productList) {
				out.println("<article>"
				+ "<header>"
				+ "<h3><a href=\"/SupCommerce-2-2/showProduct?id=" + product.getId() + "\">Product Id " + product.getId() + "</a></h3>"
				+ "</header>"
				+ "<section>"
